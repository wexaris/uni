...
private:
    ...
    public:
        ...
        inline IType& operator*() const  { return static_cast<Node*>(m_Node)->Data; }
        inline IType* operator->() const { return &static_cast<Node*>(m_Node)->Data; }
    ...
    public:
        ...
        inline const IType& operator*() const  { return static_cast<const Node*>(m_Node)->Data; }
        inline const IType* operator->() const { return &static_cast<const Node*>(m_Node)->Data; }
...
public:
    ...
    iterator erase_after(const const_iterator& start, const const_iterator& end = cend()) {
    ...
    inline Type& front()             { return static_cast<Node*>(m_Head->Next)->Data; }
    inline const Type& front() const { return static_cast<Node*>(m_Head->Next)->Data; }
